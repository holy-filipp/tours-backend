...
namespace Illuminate\Support\Facades {
    ...
    class Response {
        ...
        {
            return \Illuminate\Routing\ResponseFactory::success($data, $message, $status);
        }
         ...
         * @static
         */
        public static function error($errors = [], $message = 'Error', $status = 400)
        {
            return \Illuminate\Routing\ResponseFactory::error($errors, $message, $status);
        }
